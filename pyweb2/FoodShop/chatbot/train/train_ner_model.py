...
# 학습용 말뭉치 데이터를 불러옴
corpus = read_file('c:/work/python/pyweb2/FoodShop/chatbot/data/ner_train.txt')
...
model = keras.models.load_model('c:/work/python/pyweb2/FoodShop/chatbot/model/ner_model.h5')
